//based on URLQueryFragmentConvertible.swift from vapor/vapor
// https://github.com/vapor/vapor/blob/main/Sources/Vapor/URLEncodedForm/URLQueryFragmentConvertible.swift
import Foundation
